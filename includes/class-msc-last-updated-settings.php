...
class MSC_Last_Updated_Settings {
    ...
    public function enqueue_admin_styles() {
        ...
        $allowed_pages = array( 'msc-site-care', 'msclu-settings', 'msc-site-care-upgrade' );
    ...
    public function render_page() {
        ...
        <div class="wrap msc-admin-wrap">
            ...
            <?php if ( isset( $_GET['updated'] ) ) : ?>
                <div class="msc-admin-notice"><p><?php esc_html_e( 'Settings saved.', 'msc-last-updated' ); ?></p></div>
            <?php endif; ?>
                ...
                <form method="post" action="">
                    ...
                    <table class="form-table" role="presentation">
                        ...
                        <tr>
                            ...
                            <td>
                                <input type="number" min="0" class="msc-admin-input" name="msclu[days_threshold]" value="<?php echo esc_attr( $options['days_threshold'] ); ?>" />
                        ...
                        <tr>
                            ...
                            <td>
                                <select class="msc-admin-select" name="msclu[position]">
                        ...
                        <tr>
                            ...
                            <td>
                                <input type="text" class="regular-text msc-admin-input" name="msclu[template]" value="<?php echo esc_attr( $options['template'] ); ?>" />
                                <p class="description"><?php esc_html_e( 'Use {date} token for the formatted date.', 'msc-last-updated' ); ?></p>
                            </td>
                        </tr>
                    </table>

                    <?php submit_button( __( 'Save Settings', 'msc-last-updated' ), 'primary msc-admin-button msc-admin-button-primary', 'msclu_settings_submit' ); ?>
                </form>
            </div>
        </div>
        <?php
...
if ( ! function_exists( 'msc_render_combined_upgrade_page' ) ) {
    function msc_render_combined_upgrade_page() {
        ...
        echo '<div class="wrap msc-admin-wrap">';
        echo '<div class="msc-admin-header"><h1>' . esc_html__( 'Upgrade to Pro', 'msc-last-updated' ) . '</h1></div>';
        echo '<div class="msc-admin-card">';
        echo '<p>' . esc_html__( 'Upgrade individual modules to unlock more features for each plugin.', 'msc-last-updated' ) . '</p>';
        echo '</div>';
        if ( empty( $sections ) ) {
            echo '<div class="msc-admin-card"><p>' . esc_html__( 'No upgrades available.', 'msc-last-updated' ) . '</p></div>';
        } else {
